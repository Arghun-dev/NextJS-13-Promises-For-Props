...
To use Middleware, create a file named `middleware.ts` in the `root` of your project, at the same level as `pages` or `app`, or inside `src` if you're using that directory structure.
